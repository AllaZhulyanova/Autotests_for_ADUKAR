...
# доступ к тестам с авторизацией, оплатой, проверкой безопасности для рос номера телефона

def test_opening_test_with_authorization_without_payment (app):
    app.Session.Log_in(Login = "ev.point46@mail.ru", Password = "YdoVthnzbh")  # вход в ЛК
    app.Button_menu.Test_Button_Videocourses() # кнопка "Видеокурсы"
    result_wiht_blr_phone = app.List_items_after_autorization.Test_security_items(TEXT="ТЕСТ",Promo_for_payment='Gsudjcjp3',Phone='+79001111111',Sms_code='554306')
