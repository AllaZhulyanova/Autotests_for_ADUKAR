...
# доступ к ТТ урока после авторизации, оплаты и прохождение проверки безопасности с помощью белорусского номера телефона

def test_opening_test_with_authorization_without_payment (app):
    app.Session.Log_in(Login = "ev.point50@mail.ru", Password = "qUwyhIhQPZ")  # вход в ЛК
    app.Button_menu.Test_Button_Videocourses() # кнопка "Видеокурсы"
    result_wiht_blr_phone = app.List_items_after_autorization.Test_security_items(TEXT="УРОК",Promo_for_payment='Gsudjcjp3',Phone='+375445359850',Sms_code='554306')
