...
# доступ к тестам с авторизацией, оплатой, проверкой безопасности для белорусского номера телефона

def test_opening_test_with_authorization_without_payment (app):
    app.Session.Log_in(Login = "ev.point45@mail.ru", Password = "DzHYWfDkok")  # вход в ЛК
    app.Button_menu.Test_Button_Videocourses() # кнопка "Видеокурсы"
    result_wiht_blr_phone = app.List_items_after_autorization.Test_security_items(TEXT="ТЕСТ",Promo_for_payment='Gsudjcjp3',Phone='+375445359850',Sms_code='554306')
    ...
    print('заменить логин и пароль в тесте Test_videocourses_access_to_tests_with_authorization_payment_security_for_blr_phone.py')